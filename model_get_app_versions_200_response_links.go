...
// checks if the GetAppVersions200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppVersions200ResponseLinks{}

// GetAppVersions200ResponseLinks struct for GetAppVersions200ResponseLinks
type GetAppVersions200ResponseLinks struct {
...
type _GetAppVersions200ResponseLinks GetAppVersions200ResponseLinks
...
func NewGetAppVersions200ResponseLinks() *GetAppVersions200ResponseLinks {
	this := GetAppVersions200ResponseLinks{}
	return &this
}
...
func (o *GetAppVersions200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetAppVersions200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetAppVersions200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetAppVersions200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppVersions200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetAppVersions200ResponseLinks := _GetAppVersions200ResponseLinks{}

	err = json.Unmarshal(data, &varGetAppVersions200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetAppVersions200ResponseLinks(varGetAppVersions200ResponseLinks)
...
type NullableGetAppVersions200ResponseLinks struct {
	value *GetAppVersions200ResponseLinks
	isSet bool
}

func (v NullableGetAppVersions200ResponseLinks) Get() *GetAppVersions200ResponseLinks {
	return v.value
}

func (v *NullableGetAppVersions200ResponseLinks) Set(val *GetAppVersions200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppVersions200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppVersions200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppVersions200ResponseLinks(val *GetAppVersions200ResponseLinks) *NullableGetAppVersions200ResponseLinks {
	return &NullableGetAppVersions200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetAppVersions200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppVersions200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
