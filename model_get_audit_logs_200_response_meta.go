...
// checks if the GetAuditLogs200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAuditLogs200ResponseMeta{}

// GetAuditLogs200ResponseMeta struct for GetAuditLogs200ResponseMeta
type GetAuditLogs200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetAuditLogs200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetAuditLogs200ResponseMeta GetAuditLogs200ResponseMeta
...
func NewGetAuditLogs200ResponseMeta() *GetAuditLogs200ResponseMeta {
	this := GetAuditLogs200ResponseMeta{}
	return &this
}
...
func (o *GetAuditLogs200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetAuditLogs200ResponseMeta) GetLinks() []GetAuditLogs200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetAuditLogs200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetAuditLogs200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetAuditLogs200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetAuditLogs200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetAuditLogs200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetAuditLogs200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetAuditLogs200ResponseMeta := _GetAuditLogs200ResponseMeta{}

	err = json.Unmarshal(data, &varGetAuditLogs200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetAuditLogs200ResponseMeta(varGetAuditLogs200ResponseMeta)
...
type NullableGetAuditLogs200ResponseMeta struct {
	value *GetAuditLogs200ResponseMeta
	isSet bool
}

func (v NullableGetAuditLogs200ResponseMeta) Get() *GetAuditLogs200ResponseMeta {
	return v.value
}

func (v *NullableGetAuditLogs200ResponseMeta) Set(val *GetAuditLogs200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAuditLogs200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAuditLogs200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAuditLogs200ResponseMeta(val *GetAuditLogs200ResponseMeta) *NullableGetAuditLogs200ResponseMeta {
	return &NullableGetAuditLogs200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetAuditLogs200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAuditLogs200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
