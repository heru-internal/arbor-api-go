...
// checks if the GetApps200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetApps200ResponseLinks{}

// GetApps200ResponseLinks struct for GetApps200ResponseLinks
type GetApps200ResponseLinks struct {
...
type _GetApps200ResponseLinks GetApps200ResponseLinks
...
func (o *GetApps200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetApps200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetApps200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetApps200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetApps200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetApps200ResponseLinks := _GetApps200ResponseLinks{}

	err = json.Unmarshal(data, &varGetApps200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetApps200ResponseLinks(varGetApps200ResponseLinks)
...
type NullableGetApps200ResponseLinks struct {
	value *GetApps200ResponseLinks
	isSet bool
}

func (v NullableGetApps200ResponseLinks) Get() *GetApps200ResponseLinks {
	return v.value
}

func (v *NullableGetApps200ResponseLinks) Set(val *GetApps200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetApps200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetApps200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetApps200ResponseLinks(val *GetApps200ResponseLinks) *NullableGetApps200ResponseLinks {
	return &NullableGetApps200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetApps200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetApps200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
