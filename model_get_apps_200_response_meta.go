...
// checks if the GetApps200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetApps200ResponseMeta{}

// GetApps200ResponseMeta struct for GetApps200ResponseMeta
type GetApps200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetApps200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetApps200ResponseMeta GetApps200ResponseMeta
...
func (o *GetApps200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetApps200ResponseMeta) GetLinks() []GetApps200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetApps200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetApps200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetApps200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetApps200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetApps200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetApps200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetApps200ResponseMeta := _GetApps200ResponseMeta{}

	err = json.Unmarshal(data, &varGetApps200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetApps200ResponseMeta(varGetApps200ResponseMeta)
...
type NullableGetApps200ResponseMeta struct {
	value *GetApps200ResponseMeta
	isSet bool
}

func (v NullableGetApps200ResponseMeta) Get() *GetApps200ResponseMeta {
	return v.value
}

func (v *NullableGetApps200ResponseMeta) Set(val *GetApps200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetApps200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetApps200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetApps200ResponseMeta(val *GetApps200ResponseMeta) *NullableGetApps200ResponseMeta {
	return &NullableGetApps200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetApps200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetApps200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
