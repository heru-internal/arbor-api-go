...
// checks if the GetThemes200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetThemes200ResponseMeta{}

// GetThemes200ResponseMeta struct for GetThemes200ResponseMeta
type GetThemes200ResponseMeta struct {
...
type _GetThemes200ResponseMeta GetThemes200ResponseMeta
...
func (o *GetThemes200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetThemes200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetThemes200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetThemes200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetThemes200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetThemes200ResponseMeta := _GetThemes200ResponseMeta{}

	err = json.Unmarshal(data, &varGetThemes200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetThemes200ResponseMeta(varGetThemes200ResponseMeta)
...
type NullableGetThemes200ResponseMeta struct {
	value *GetThemes200ResponseMeta
	isSet bool
}

func (v NullableGetThemes200ResponseMeta) Get() *GetThemes200ResponseMeta {
	return v.value
}

func (v *NullableGetThemes200ResponseMeta) Set(val *GetThemes200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetThemes200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetThemes200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetThemes200ResponseMeta(val *GetThemes200ResponseMeta) *NullableGetThemes200ResponseMeta {
	return &NullableGetThemes200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetThemes200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetThemes200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
