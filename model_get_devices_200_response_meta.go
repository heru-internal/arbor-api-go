...
// checks if the GetDevices200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDevices200ResponseMeta{}

// GetDevices200ResponseMeta struct for GetDevices200ResponseMeta
type GetDevices200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetDevices200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetDevices200ResponseMeta GetDevices200ResponseMeta
...
func NewGetDevices200ResponseMeta() *GetDevices200ResponseMeta {
	this := GetDevices200ResponseMeta{}
	return &this
}
...
func (o *GetDevices200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetDevices200ResponseMeta) GetLinks() []GetDevices200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetDevices200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetDevices200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetDevices200ResponseMeta) HasPath() bool {
	if o != nil && !IsNil(o.Path) {
		return true
	}
...
func (o *GetDevices200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetDevices200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetDevices200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetDevices200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetDevices200ResponseMeta := _GetDevices200ResponseMeta{}

	err = json.Unmarshal(data, &varGetDevices200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetDevices200ResponseMeta(varGetDevices200ResponseMeta)
...
type NullableGetDevices200ResponseMeta struct {
	value *GetDevices200ResponseMeta
	isSet bool
}

func (v NullableGetDevices200ResponseMeta) Get() *GetDevices200ResponseMeta {
	return v.value
}

func (v *NullableGetDevices200ResponseMeta) Set(val *GetDevices200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDevices200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDevices200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDevices200ResponseMeta(val *GetDevices200ResponseMeta) *NullableGetDevices200ResponseMeta {
	return &NullableGetDevices200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetDevices200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDevices200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
