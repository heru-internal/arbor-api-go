...
// checks if the GetAppUsage200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppUsage200ResponseMeta{}

// GetAppUsage200ResponseMeta struct for GetAppUsage200ResponseMeta
type GetAppUsage200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetAppUsage200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetAppUsage200ResponseMeta GetAppUsage200ResponseMeta
...
func NewGetAppUsage200ResponseMeta() *GetAppUsage200ResponseMeta {
	this := GetAppUsage200ResponseMeta{}
	return &this
}
...
func (o *GetAppUsage200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetAppUsage200ResponseMeta) GetLinks() []GetAppUsage200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetAppUsage200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetAppUsage200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetAppUsage200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetAppUsage200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetAppUsage200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppUsage200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetAppUsage200ResponseMeta := _GetAppUsage200ResponseMeta{}

	err = json.Unmarshal(data, &varGetAppUsage200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetAppUsage200ResponseMeta(varGetAppUsage200ResponseMeta)
...
type NullableGetAppUsage200ResponseMeta struct {
	value *GetAppUsage200ResponseMeta
	isSet bool
}

func (v NullableGetAppUsage200ResponseMeta) Get() *GetAppUsage200ResponseMeta {
	return v.value
}

func (v *NullableGetAppUsage200ResponseMeta) Set(val *GetAppUsage200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppUsage200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppUsage200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppUsage200ResponseMeta(val *GetAppUsage200ResponseMeta) *NullableGetAppUsage200ResponseMeta {
	return &NullableGetAppUsage200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetAppUsage200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppUsage200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
