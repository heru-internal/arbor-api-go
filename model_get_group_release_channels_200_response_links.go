...
// checks if the GetGroupReleaseChannels200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupReleaseChannels200ResponseLinks{}

// GetGroupReleaseChannels200ResponseLinks struct for GetGroupReleaseChannels200ResponseLinks
type GetGroupReleaseChannels200ResponseLinks struct {
...
type _GetGroupReleaseChannels200ResponseLinks GetGroupReleaseChannels200ResponseLinks
...
func NewGetGroupReleaseChannels200ResponseLinks() *GetGroupReleaseChannels200ResponseLinks {
	this := GetGroupReleaseChannels200ResponseLinks{}
	return &this
}
...
func (o *GetGroupReleaseChannels200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetGroupReleaseChannels200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetGroupReleaseChannels200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetGroupReleaseChannels200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetGroupReleaseChannels200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetGroupReleaseChannels200ResponseLinks := _GetGroupReleaseChannels200ResponseLinks{}

	err = json.Unmarshal(data, &varGetGroupReleaseChannels200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetGroupReleaseChannels200ResponseLinks(varGetGroupReleaseChannels200ResponseLinks)
...
type NullableGetGroupReleaseChannels200ResponseLinks struct {
	value *GetGroupReleaseChannels200ResponseLinks
	isSet bool
}

func (v NullableGetGroupReleaseChannels200ResponseLinks) Get() *GetGroupReleaseChannels200ResponseLinks {
	return v.value
}

func (v *NullableGetGroupReleaseChannels200ResponseLinks) Set(val *GetGroupReleaseChannels200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupReleaseChannels200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupReleaseChannels200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupReleaseChannels200ResponseLinks(val *GetGroupReleaseChannels200ResponseLinks) *NullableGetGroupReleaseChannels200ResponseLinks {
	return &NullableGetGroupReleaseChannels200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetGroupReleaseChannels200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupReleaseChannels200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
