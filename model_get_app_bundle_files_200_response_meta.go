...
// checks if the GetAppBundleFiles200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppBundleFiles200ResponseMeta{}

// GetAppBundleFiles200ResponseMeta struct for GetAppBundleFiles200ResponseMeta
type GetAppBundleFiles200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetAppBundleFiles200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetAppBundleFiles200ResponseMeta GetAppBundleFiles200ResponseMeta
...
func NewGetAppBundleFiles200ResponseMeta() *GetAppBundleFiles200ResponseMeta {
	this := GetAppBundleFiles200ResponseMeta{}
	return &this
}
...
func (o *GetAppBundleFiles200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetAppBundleFiles200ResponseMeta) GetLinks() []GetAppBundleFiles200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetAppBundleFiles200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetAppBundleFiles200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetAppBundleFiles200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetAppBundleFiles200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetAppBundleFiles200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppBundleFiles200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetAppBundleFiles200ResponseMeta := _GetAppBundleFiles200ResponseMeta{}

	err = json.Unmarshal(data, &varGetAppBundleFiles200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetAppBundleFiles200ResponseMeta(varGetAppBundleFiles200ResponseMeta)
...
type NullableGetAppBundleFiles200ResponseMeta struct {
	value *GetAppBundleFiles200ResponseMeta
	isSet bool
}

func (v NullableGetAppBundleFiles200ResponseMeta) Get() *GetAppBundleFiles200ResponseMeta {
	return v.value
}

func (v *NullableGetAppBundleFiles200ResponseMeta) Set(val *GetAppBundleFiles200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppBundleFiles200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppBundleFiles200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppBundleFiles200ResponseMeta(val *GetAppBundleFiles200ResponseMeta) *NullableGetAppBundleFiles200ResponseMeta {
	return &NullableGetAppBundleFiles200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetAppBundleFiles200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppBundleFiles200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
