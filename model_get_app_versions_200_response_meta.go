...
// checks if the GetAppVersions200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppVersions200ResponseMeta{}

// GetAppVersions200ResponseMeta struct for GetAppVersions200ResponseMeta
type GetAppVersions200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetAppVersions200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetAppVersions200ResponseMeta GetAppVersions200ResponseMeta
...
func NewGetAppVersions200ResponseMeta() *GetAppVersions200ResponseMeta {
	this := GetAppVersions200ResponseMeta{}
	return &this
}
...
func (o *GetAppVersions200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetAppVersions200ResponseMeta) GetLinks() []GetAppVersions200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetAppVersions200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetAppVersions200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetAppVersions200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetAppVersions200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetAppVersions200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppVersions200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetAppVersions200ResponseMeta := _GetAppVersions200ResponseMeta{}

	err = json.Unmarshal(data, &varGetAppVersions200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetAppVersions200ResponseMeta(varGetAppVersions200ResponseMeta)
...
type NullableGetAppVersions200ResponseMeta struct {
	value *GetAppVersions200ResponseMeta
	isSet bool
}

func (v NullableGetAppVersions200ResponseMeta) Get() *GetAppVersions200ResponseMeta {
	return v.value
}

func (v *NullableGetAppVersions200ResponseMeta) Set(val *GetAppVersions200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppVersions200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppVersions200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppVersions200ResponseMeta(val *GetAppVersions200ResponseMeta) *NullableGetAppVersions200ResponseMeta {
	return &NullableGetAppVersions200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetAppVersions200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppVersions200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
