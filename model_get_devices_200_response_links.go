...
// checks if the GetDevices200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDevices200ResponseLinks{}

// GetDevices200ResponseLinks struct for GetDevices200ResponseLinks
type GetDevices200ResponseLinks struct {
...
type _GetDevices200ResponseLinks GetDevices200ResponseLinks
...
func NewGetDevices200ResponseLinks() *GetDevices200ResponseLinks {
	this := GetDevices200ResponseLinks{}
	return &this
}
...
func (o *GetDevices200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetDevices200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetDevices200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetDevices200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetDevices200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetDevices200ResponseLinks := _GetDevices200ResponseLinks{}

	err = json.Unmarshal(data, &varGetDevices200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetDevices200ResponseLinks(varGetDevices200ResponseLinks)
...
type NullableGetDevices200ResponseLinks struct {
	value *GetDevices200ResponseLinks
	isSet bool
}

func (v NullableGetDevices200ResponseLinks) Get() *GetDevices200ResponseLinks {
	return v.value
}

func (v *NullableGetDevices200ResponseLinks) Set(val *GetDevices200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDevices200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDevices200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDevices200ResponseLinks(val *GetDevices200ResponseLinks) *NullableGetDevices200ResponseLinks {
	return &NullableGetDevices200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetDevices200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDevices200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
