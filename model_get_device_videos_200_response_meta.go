...
// checks if the GetDeviceVideos200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceVideos200ResponseMeta{}

// GetDeviceVideos200ResponseMeta struct for GetDeviceVideos200ResponseMeta
type GetDeviceVideos200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetDeviceVideos200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetDeviceVideos200ResponseMeta GetDeviceVideos200ResponseMeta
...
func NewGetDeviceVideos200ResponseMeta() *GetDeviceVideos200ResponseMeta {
	this := GetDeviceVideos200ResponseMeta{}
	return &this
}
...
func (o *GetDeviceVideos200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetDeviceVideos200ResponseMeta) GetLinks() []GetDeviceVideos200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetDeviceVideos200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetDeviceVideos200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetDeviceVideos200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetDeviceVideos200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceVideos200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetDeviceVideos200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetDeviceVideos200ResponseMeta := _GetDeviceVideos200ResponseMeta{}

	err = json.Unmarshal(data, &varGetDeviceVideos200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetDeviceVideos200ResponseMeta(varGetDeviceVideos200ResponseMeta)
...
type NullableGetDeviceVideos200ResponseMeta struct {
	value *GetDeviceVideos200ResponseMeta
	isSet bool
}

func (v NullableGetDeviceVideos200ResponseMeta) Get() *GetDeviceVideos200ResponseMeta {
	return v.value
}

func (v *NullableGetDeviceVideos200ResponseMeta) Set(val *GetDeviceVideos200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceVideos200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceVideos200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceVideos200ResponseMeta(val *GetDeviceVideos200ResponseMeta) *NullableGetDeviceVideos200ResponseMeta {
	return &NullableGetDeviceVideos200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetDeviceVideos200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceVideos200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
