...
// checks if the GetDeviceReleaseChannels200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceReleaseChannels200ResponseMeta{}

// GetDeviceReleaseChannels200ResponseMeta struct for GetDeviceReleaseChannels200ResponseMeta
type GetDeviceReleaseChannels200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetDeviceReleaseChannels200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetDeviceReleaseChannels200ResponseMeta GetDeviceReleaseChannels200ResponseMeta
...
func NewGetDeviceReleaseChannels200ResponseMeta() *GetDeviceReleaseChannels200ResponseMeta {
	this := GetDeviceReleaseChannels200ResponseMeta{}
	return &this
}
...
func (o *GetDeviceReleaseChannels200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetDeviceReleaseChannels200ResponseMeta) GetLinks() []GetDeviceReleaseChannels200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetDeviceReleaseChannels200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetDeviceReleaseChannels200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetDeviceReleaseChannels200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetDeviceReleaseChannels200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceReleaseChannels200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetDeviceReleaseChannels200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetDeviceReleaseChannels200ResponseMeta := _GetDeviceReleaseChannels200ResponseMeta{}

	err = json.Unmarshal(data, &varGetDeviceReleaseChannels200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetDeviceReleaseChannels200ResponseMeta(varGetDeviceReleaseChannels200ResponseMeta)
...
type NullableGetDeviceReleaseChannels200ResponseMeta struct {
	value *GetDeviceReleaseChannels200ResponseMeta
	isSet bool
}

func (v NullableGetDeviceReleaseChannels200ResponseMeta) Get() *GetDeviceReleaseChannels200ResponseMeta {
	return v.value
}

func (v *NullableGetDeviceReleaseChannels200ResponseMeta) Set(val *GetDeviceReleaseChannels200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceReleaseChannels200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceReleaseChannels200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceReleaseChannels200ResponseMeta(val *GetDeviceReleaseChannels200ResponseMeta) *NullableGetDeviceReleaseChannels200ResponseMeta {
	return &NullableGetDeviceReleaseChannels200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetDeviceReleaseChannels200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceReleaseChannels200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
