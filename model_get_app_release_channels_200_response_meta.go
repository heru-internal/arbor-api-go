...
// checks if the GetAppReleaseChannels200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppReleaseChannels200ResponseMeta{}

// GetAppReleaseChannels200ResponseMeta struct for GetAppReleaseChannels200ResponseMeta
type GetAppReleaseChannels200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetAppReleaseChannels200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetAppReleaseChannels200ResponseMeta GetAppReleaseChannels200ResponseMeta
...
func NewGetAppReleaseChannels200ResponseMeta() *GetAppReleaseChannels200ResponseMeta {
	this := GetAppReleaseChannels200ResponseMeta{}
	return &this
}
...
func (o *GetAppReleaseChannels200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetAppReleaseChannels200ResponseMeta) GetLinks() []GetAppReleaseChannels200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetAppReleaseChannels200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetAppReleaseChannels200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetAppReleaseChannels200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetAppReleaseChannels200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetAppReleaseChannels200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppReleaseChannels200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetAppReleaseChannels200ResponseMeta := _GetAppReleaseChannels200ResponseMeta{}

	err = json.Unmarshal(data, &varGetAppReleaseChannels200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetAppReleaseChannels200ResponseMeta(varGetAppReleaseChannels200ResponseMeta)
...
type NullableGetAppReleaseChannels200ResponseMeta struct {
	value *GetAppReleaseChannels200ResponseMeta
	isSet bool
}

func (v NullableGetAppReleaseChannels200ResponseMeta) Get() *GetAppReleaseChannels200ResponseMeta {
	return v.value
}

func (v *NullableGetAppReleaseChannels200ResponseMeta) Set(val *GetAppReleaseChannels200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppReleaseChannels200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppReleaseChannels200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppReleaseChannels200ResponseMeta(val *GetAppReleaseChannels200ResponseMeta) *NullableGetAppReleaseChannels200ResponseMeta {
	return &NullableGetAppReleaseChannels200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetAppReleaseChannels200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppReleaseChannels200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
