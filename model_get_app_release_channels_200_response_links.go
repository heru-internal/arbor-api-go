...
// checks if the GetAppReleaseChannels200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAppReleaseChannels200ResponseLinks{}

// GetAppReleaseChannels200ResponseLinks struct for GetAppReleaseChannels200ResponseLinks
type GetAppReleaseChannels200ResponseLinks struct {
...
type _GetAppReleaseChannels200ResponseLinks GetAppReleaseChannels200ResponseLinks
...
func NewGetAppReleaseChannels200ResponseLinks() *GetAppReleaseChannels200ResponseLinks {
	this := GetAppReleaseChannels200ResponseLinks{}
	return &this
}
...
func (o *GetAppReleaseChannels200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetAppReleaseChannels200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetAppReleaseChannels200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetAppReleaseChannels200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetAppReleaseChannels200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetAppReleaseChannels200ResponseLinks := _GetAppReleaseChannels200ResponseLinks{}

	err = json.Unmarshal(data, &varGetAppReleaseChannels200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetAppReleaseChannels200ResponseLinks(varGetAppReleaseChannels200ResponseLinks)
...
type NullableGetAppReleaseChannels200ResponseLinks struct {
	value *GetAppReleaseChannels200ResponseLinks
	isSet bool
}

func (v NullableGetAppReleaseChannels200ResponseLinks) Get() *GetAppReleaseChannels200ResponseLinks {
	return v.value
}

func (v *NullableGetAppReleaseChannels200ResponseLinks) Set(val *GetAppReleaseChannels200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAppReleaseChannels200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAppReleaseChannels200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAppReleaseChannels200ResponseLinks(val *GetAppReleaseChannels200ResponseLinks) *NullableGetAppReleaseChannels200ResponseLinks {
	return &NullableGetAppReleaseChannels200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetAppReleaseChannels200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAppReleaseChannels200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
