...
// checks if the GetUsers200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUsers200ResponseLinks{}

// GetUsers200ResponseLinks struct for GetUsers200ResponseLinks
type GetUsers200ResponseLinks struct {
...
type _GetUsers200ResponseLinks GetUsers200ResponseLinks
...
func (o *GetUsers200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetUsers200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetUsers200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetUsers200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetUsers200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetUsers200ResponseLinks := _GetUsers200ResponseLinks{}

	err = json.Unmarshal(data, &varGetUsers200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetUsers200ResponseLinks(varGetUsers200ResponseLinks)
...
type NullableGetUsers200ResponseLinks struct {
	value *GetUsers200ResponseLinks
	isSet bool
}

func (v NullableGetUsers200ResponseLinks) Get() *GetUsers200ResponseLinks {
	return v.value
}

func (v *NullableGetUsers200ResponseLinks) Set(val *GetUsers200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUsers200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUsers200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUsers200ResponseLinks(val *GetUsers200ResponseLinks) *NullableGetUsers200ResponseLinks {
	return &NullableGetUsers200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetUsers200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUsers200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
