...
// checks if the GetDeviceModels200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceModels200ResponseMeta{}

// GetDeviceModels200ResponseMeta struct for GetDeviceModels200ResponseMeta
type GetDeviceModels200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetDeviceModels200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetDeviceModels200ResponseMeta GetDeviceModels200ResponseMeta
...
func NewGetDeviceModels200ResponseMeta() *GetDeviceModels200ResponseMeta {
	this := GetDeviceModels200ResponseMeta{}
	return &this
}
...
func (o *GetDeviceModels200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetDeviceModels200ResponseMeta) GetLinks() []GetDeviceModels200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetDeviceModels200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetDeviceModels200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetDeviceModels200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetDeviceModels200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceModels200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetDeviceModels200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetDeviceModels200ResponseMeta := _GetDeviceModels200ResponseMeta{}

	err = json.Unmarshal(data, &varGetDeviceModels200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetDeviceModels200ResponseMeta(varGetDeviceModels200ResponseMeta)
...
type NullableGetDeviceModels200ResponseMeta struct {
	value *GetDeviceModels200ResponseMeta
	isSet bool
}

func (v NullableGetDeviceModels200ResponseMeta) Get() *GetDeviceModels200ResponseMeta {
	return v.value
}

func (v *NullableGetDeviceModels200ResponseMeta) Set(val *GetDeviceModels200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceModels200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceModels200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceModels200ResponseMeta(val *GetDeviceModels200ResponseMeta) *NullableGetDeviceModels200ResponseMeta {
	return &NullableGetDeviceModels200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetDeviceModels200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceModels200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
