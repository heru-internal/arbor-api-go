...
// checks if the GetRoles200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRoles200ResponseMeta{}

// GetRoles200ResponseMeta struct for GetRoles200ResponseMeta
type GetRoles200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetRoles200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetRoles200ResponseMeta GetRoles200ResponseMeta
...
func (o *GetRoles200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetRoles200ResponseMeta) GetLinks() []GetRoles200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetRoles200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetRoles200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetRoles200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetRoles200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetRoles200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetRoles200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetRoles200ResponseMeta := _GetRoles200ResponseMeta{}

	err = json.Unmarshal(data, &varGetRoles200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetRoles200ResponseMeta(varGetRoles200ResponseMeta)
...
type NullableGetRoles200ResponseMeta struct {
	value *GetRoles200ResponseMeta
	isSet bool
}

func (v NullableGetRoles200ResponseMeta) Get() *GetRoles200ResponseMeta {
	return v.value
}

func (v *NullableGetRoles200ResponseMeta) Set(val *GetRoles200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRoles200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRoles200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRoles200ResponseMeta(val *GetRoles200ResponseMeta) *NullableGetRoles200ResponseMeta {
	return &NullableGetRoles200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetRoles200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRoles200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
